...
const RegisterForm = () => {
  ...
  */
  ...
  const FormComponent = () => {
    ...
    const [ errorState, setErrorState ] = useState({ 'firstname': null, 'lastname': null, 
    ...
    const authenticateUser = () => {
        // Init authentication
        setErrorState({ 'firstname': null, 'lastname': null, 'email': null, 'password': null });
        setLoading(true);
    ...
    return (
      <React.Fragment>
        ...
        <Form style={styles.FormBox}>
          ...
          <Form.Field style={styles.inputField}>
            <input id="password" type="password" placeholder='Password (atleast 6 chars long)'
  ...
  const Verified = () => {
    return (
      <React.Fragment style={{ width: '100%' }}>
        ...
        <br />
        <label className="verf-login"><a href="/login" style={styles.label.a}>Login</a></label>
      </React.Fragment>
    );
  }
